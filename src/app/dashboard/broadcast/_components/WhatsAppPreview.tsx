...
function ChatHeader({ businessName }: { businessName: string }) {
  ...
  return (
    <div className="flex items-center justify-between gap-1.5 px-3 py-2 shrink-0 bg-[#ffffff] border-b border-slate-100 shadow-sm select-none">
      <div className="flex items-center gap-2 min-w-0">
        ...
        <div className="flex items-center gap-1 shrink-0">
          <svg
            ...
            viewBox="0 0 12 20"
            fill="none"
            className="opacity-80 cursor-pointer text-[#008069]"
          >
            <path
              d="M10 2L2 10L10 18"
              stroke="currentColor"
          ...
          <div className="relative">
            <div className="w-8 h-8 rounded-full bg-[#008069]/10 flex items-center justify-center border border-[#008069]/20">
        ...
        <div className="min-w-0 text-left">
          <div className="flex items-center gap-0.5">
            <p className="text-[14.5px] font-bold text-[#111b21] truncate leading-tight">
              {businessName}
            </p>
            <BadgeCheck className="w-3.5 h-3.5 text-[#008069] shrink-0" />
          </div>
          <p className="text-[10.5px] text-muted-foreground leading-tight mt-0.5">Online</p>
        </div>
      </div>

      {/* Actions */}
      <div className="flex items-center gap-3 shrink-0 text-[#008069]">
    ...
    if (mediaUrl) {
      return (
        ...
        <img
          src={mediaUrl}
          alt="Header media"
          className="w-full rounded-lg mb-2 object-contain max-w-full"
          style={{ maxHeight: 180 }}
        />
      );
    }
...
function PreviewButton({ button }: { button: ParsedButton }) {
  ...
  return (
    <div className="flex items-center justify-center gap-2 py-3 px-4 hover:bg-slate-50/50 transition-colors duration-150 cursor-pointer w-full max-w-full">
      {isUrl && <ExternalLink className="w-3.5 h-3.5 text-[#0066cc] shrink-0" />}
      {isPhone && <Phone className="w-3.5 h-3.5 text-[#0066cc] shrink-0" />}
      <span className="text-[13px] font-semibold text-[#0066cc] leading-tight truncate max-w-full">
        {button.text}
      </span>
    </div>
  );
    ...
    <div className="flex flex-col gap-2 w-full items-center">
      ...
      <div className="preview-device-wrapper">
        <div className="preview-device-scale">
          {/* Phone Shell */}
          <div className="phone-shell device-container relative select-none">
            {/* Phone Viewport Mask */}
            <div className="phone-viewport-mask border-[2.6px] border-[#18191c] dark:border-[#141517] bg-[#efeae2] flex flex-col w-full transition-all duration-300">
              ...
              <div className="flex flex-col bg-[#efeae2] w-full h-full overflow-hidden">
                {/* Status bar */}
                <StatusBar />
                ...
                <div
                  className="relative px-4 py-4 w-full flex-1 overflow-y-auto no-scrollbar"
                  style={{
                    backgroundImage:
                ...
                >
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex justify-center">
                      <span className="text-[11.5px] text-[#667781] bg-white/85 px-2.5 py-0.5 rounded-md shadow-sm font-semibold uppercase tracking-wide">
                        Today
                      </span>
                    </div>
                    ...
                    <AnimatePresence mode="wait">
                      {template ? (
                        ...
                        >
                          ...
                          <div
                            className="relative max-w-[85%] rounded-2xl rounded-tr-none overflow-hidden px-4 pt-3 pb-2 bg-[#d9fdd3] text-[#111b21] shadow-[0_1px_3px_rgba(0,0,0,0.10),0_2px_6px_rgba(0,0,0,0.05)] w-full"
                          >
                            {/* Bubble tail element */}
                            <div
                            ...
                            <div className="pt-0.5 select-text">
                              <AnimatePresence mode="wait">
                                <motion.p
                                  ...
                                  className="text-[16px] text-[#111b21] leading-[1.6] whitespace-pre-wrap break-words tracking-normal font-normal"
                                >
                              ...
                              {/* Footer */}
                              {footer && (
                                <p className="text-[12px] text-[#667781] mt-2 leading-snug">
                                  {footer}
                                </p>
                              )}
                              ...
                              <div className="flex items-center justify-end gap-1 mt-2 pb-0.5">
                                <span className="text-[10px] text-[#667781] font-medium leading-none">
                                  9:41 AM
                                </span>
                ...
                <div className="flex items-center gap-2.5 px-3 py-2.5 shrink-0 bg-[#f0f2f5] border-t border-slate-200/30">
                  <div className="flex-1 h-8.5 bg-white rounded-full flex items-center px-4 shadow-sm border border-slate-200/50">
                    <span className="text-[13.5px] text-slate-400">Message</span>
                  </div>
                  <div
