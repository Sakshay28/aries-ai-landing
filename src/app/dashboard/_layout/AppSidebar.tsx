...
export default function AppSidebar({ userEmail, modules = [], businessType = "", isPlatformAdmin = false }: { userEmail?: string; modules?: string[]; businessType?: string; isPlatformAdmin?: boolean }) {
