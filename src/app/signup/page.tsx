        ...
        <div style={styles.formCard} className="signup-form-card">
          ...
          {!otpSent ? (
            <form onSubmit={sendSignupOtp} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: 12.5, lineHeight: 1.5, opacity: 0.95 }}>
                        ...
                        <ol style={{ margin: "6px 0 0 16px", padding: 0 }}>
                          ...
                          <li>Try signing up with that test email. It will bypass SMTP rate limits and log you in instantly!</li>
                        </ol>
                      </div>
                    </div>
                  ) : error}
              ...
              <button
                type="submit"
                disabled={loading || fullName.trim().length < 2 || businessName.trim().length < 2 || !email.includes("@")}
                style={{
                  ...styles.submitBtn,
