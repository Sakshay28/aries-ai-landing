...
export default function BillPage() {
  ...
  const [invoiceNo, setInvoiceNo] = useState("ARI/2026-08/0142");
  ...
  // Billed To Details
  const [buyerName, setBuyerName] = useState("GLOBESOME INDIA");
  const [buyerAddress, setBuyerAddress] = useState(
    "Scalability Tower, IT-46A, Doon IT Park, Sahastradhara Rd, Govind Vihar, Dehradun, Uttarakhand 248013"
  );
