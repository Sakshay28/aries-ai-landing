...
const BLUEPRINTS: Record<string, FlowBlueprint> = {
  reservation: {
    ...
    nodes: [
      ...
      { id: 'n3', type: 'intake_form',   label: 'Collect Guest Info',  x: 300, y: 320, extra: { fields: [{ key: 'guests', label: 'Number of guests', type: 'text', required: true },{ key: 'date', label: 'Preferred date', type: 'text', required: true },{ key: 'occasion', label: 'Special occasion?', type: 'text', required: false }] } },
  ...
  lead: {
    ...
    nodes: [
      ...
      { id: 'n3', type: 'intake_form', label: 'Collect Lead Info',   x: 300, y: 320, extra: { fields: [{ key: 'name', label: 'Your name', type: 'text', required: true },{ key: 'email', label: 'Email address', type: 'text', required: true },{ key: 'interest', label: 'What are you interested in?', type: 'text', required: false }] } },
  ...
  appointment: {
    ...
    nodes: [
      ...
      { id: 'n3', type: 'send_buttons',label: 'Choose Service',      x: 300, y: 320, extra: { content: 'Please choose a service:', buttons: ['Consultation','Follow-up','Emergency'] } },
      { id: 'n4', type: 'intake_form', label: 'Collect Details',     x: 300, y: 480, extra: { fields: [{ key: 'name', label: 'Full name', type: 'text', required: true },{ key: 'phone', label: 'Phone number', type: 'text', required: true },{ key: 'date', label: 'Preferred date & time', type: 'text', required: true }] } },
